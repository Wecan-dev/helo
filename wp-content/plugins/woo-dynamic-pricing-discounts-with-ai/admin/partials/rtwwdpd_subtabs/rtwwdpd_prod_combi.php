							...
							<table id="rtwproduct_table">
								<thead>
									<tr>
										...
										<th class="rtwtable_header"><?php esc_attr_e('Quantity', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></th>
						...
						<div class="options_group rtwwdpd_inactive" id="rtwwdpd_restriction_tab_combi">
							<table class="rtwwdpd_table_edit">
								<tr>
				            		...
				            		<td>
				            			<input type="number" value="<?php echo isset($rtwwdpd_prev_prod['rtwwdpd_combi_max_discount']) ? esc_attr($rtwwdpd_prev_prod['rtwwdpd_combi_max_discount']) : '' ; ?>" min="0" name="rtwwdpd_combi_max_discount">
								...
								<tr>
				            		...
				            		<td>
				            			<input type="checkbox" value="yes" name="rtwwdpd_combi_exclude_sale" <?php checked(isset( $rtwwdpd_prev_prod['rtwwdpd_combi_exclude_sale'] ) ? $rtwwdpd_prev_prod['rtwwdpd_combi_exclude_sale'] : 'no', 'yes'); ?>/>
								...
								<table id="rtwproduct_table">
									...
									<tbody id="product_list_body">
										<tr>
											...
											<td id="td_quant">
												<input type="number" min="1"  name="combi_quant[]" value=""  />
											</td>
											<td id="td_remove">
							...
							<div class="options_group rtwwdpd_inactive" id="rtwwdpd_restriction_tab_combi">
								<table class="rtwwdpd_table_edit">
									<tr>
					            		...
					            		<td>
					            			<input type="number" value="" min="0" name="rtwwdpd_combi_max_discount">
											<i class="rtwwdpd_description"><?php esc_html_e( 'This is used to set a threshold limit on the discount.', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>
											<b class="rtwwdpd_required" ><?php esc_html_e( 'Required', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?></b>
											</i>
										</td>
