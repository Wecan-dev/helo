									...
									<tbody id="product_list_body_bogo">
										...
										foreach ($rtwwdpd_prev_prod['category_id'] as $key => $val) {
											...
											<tr id="rtw_tbltr">
					                            ...
					                            <td class="td_quant">
					                            	<input type="number" min="0" class="rtwtd_quant"name="combi_quant[]" value="<?php echo esc_attr($rtwwdpd_prev_prod['combi_quant'][$key]); ?>"  />
					                            </td>
					                            <td id="td_remove">
					            ...
					            <table id="rtwbogo_table_cat_pro">
					            	...
					            	<tbody id="rtw_bogo_cat_pro">
				            			...
				            			<tr>
				            				...
				            				<td id="td_quant">
				            					<input type="number" min="0" name="bogo_quant_free[]" value="<?php echo isset($rtwwdpd_prev_prod['bogo_quant_free'][$key]) ? $rtwwdpd_prev_prod['bogo_quant_free'][$key] :''; ?>"  />
				            				</td>
				            				<td id="td_remove">
								...
								<table id="rtwcat_table_bogo">
									...
									<tbody id="product_list_body_bogo">
										<tr id="rtw_tbltr">
					                        ...
					                        <td class="td_quant">
					                        	<input type="number" min="0" class="rtwtd_quant"name="combi_quant[]" value=""  />
					                        </td>
					                        <td id="td_remove">
