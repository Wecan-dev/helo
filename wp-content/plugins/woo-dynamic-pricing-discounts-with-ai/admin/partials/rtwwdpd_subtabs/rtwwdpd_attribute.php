								...
								<div class="options_group rtwwdpd_active" id="rtwwdpd_rule_tab_combi">
									...
									<table class="rtwwdpd_table_edit">
										...
										<tr>
											...
											<td>
												...
												?>
												<select id="rtwwdpd_attributes" name="rtwwdpd_attributes" class="rtwwdpd_payment_method">
												<?php 
									...
									<tr id="rtwwdpd_attribute_val">
										...
										<?php
											...
											?>
											<select multiple="multiple" class="rtwwdpd_payment_method" name="rtwwdpd_attribute_val_col[]">
											<?php
											if(is_array($rtwwdpd_pre_col) && !empty($rtwwdpd_pre_col))
											{
											foreach ($rtwwdpd_pre_col as $colid => $col) { 
												$attr = get_term($col); ?>
												<option value="<?php echo esc_attr($colid); ?>" <?php
												selected('aa', 'aa');
												?>>
												<?php
						...
						<div class="options_group rtwwdpd_inactive" id="rtwwdpd_restriction_tab_combi">
							<table class="rtwwdpd_table_edit">
								...
								<tr>
									...
									<td>
										<input type="checkbox" value="yes" name="rtwwdpd_att_exclude_sale" <?php checked($rtwwdpd_prev_prod['rtwwdpd_att_exclude_sale'], 'yes'); ?>/>
									...
									<tr>
										...
										<tr id="rtwwdpd_attribute_val">
											...
											<td>
												...
												<select multiple="multiple" class="rtwwdpd_payment_method" name="rtwwdpd_attribute_val[]">
