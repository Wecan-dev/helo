...
=== Have a discount rule which is not available in our plugin, let us know we will implement it at == No Cost == in our Premium Plugin ===
...
1.  Product Discount Rule.
2.  Restrictions.
3.  Time Validation.
4.  Category Discount Rule.
5.  Cart-based Discount Rule.
6.  BOGO Offer.
7.  Tier Discount Rule for Product.
8.  Rules Priority & Permission Settings.
9.  General Settings.
10. BOGO rule Setting.
11. Plus Member Rule.
