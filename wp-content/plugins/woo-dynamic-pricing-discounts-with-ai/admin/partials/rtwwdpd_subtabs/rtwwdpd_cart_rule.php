							...
							<div class="options_group rtwwdpd_inactive" id="rtwwdpd_adv_tab">
								<table class="rtwwdpd_table_edit">
									<tr>
										...
										<td>
											<select id="allowed_payment_method" class="rtwwdpd_payment_method" name="allowed_payment_method[]" >
											<?php
									...
									<tr>
										...
										<td>
											<select id="allowed_shipping_method" class="rtwwdpd_ship_method" name="allowed_shipping_method[]" >
											<?php
