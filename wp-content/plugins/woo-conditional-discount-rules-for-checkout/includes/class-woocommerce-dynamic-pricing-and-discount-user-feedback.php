...
class DiscountFee_User_Feedback
{
    ...
    public function display_admin_notice()
    {
        ...
        if ( isset( $screen->base ) && ('plugins' === $screen->base || 'dotstore-plugins_page_wcdrfc-rules-list' === $screen->base) ) {
            ...
            ?>
						<img src="<?php 
            echo  esc_url( plugins_url( 'admin/images/wc-conditional-product-dpad-64.png', dirname( __FILE__ ) ) ) ;
            ?>" alt="<?php 
            printf( esc_attr__( '%s WordPress Plugin', 'woo-conditional-discount-rules-for-checkout' ), esc_attr( $this->name ) );
            ?>" />
					</div>
            ...
            ?>
						<h3><?php 
            printf( esc_html__( 'Are you enjoying %s Plugin?', 'woo-conditional-discount-rules-for-checkout' ), esc_html( $this->name ) );
            ?></h3>
						<p>
							<?php 
            ...
            ?>
							<?php 
            printf( esc_html__( 'You have been using %1$s for %2$s now. Mind leaving a review to let us know know what you think? We\'d really appreciate it!', 'woo-conditional-discount-rules-for-checkout' ), esc_html( $this->name ), esc_html( $time ) );
            ?>
						</p>
					</div>
            ...
            ?>" class="no-thanks"><?php 
            echo  esc_html__( 'No thanks / I already have', 'woo-conditional-discount-rules-for-checkout' ) ;
            ?></a>
					</div>
				</div>
			</div>
...
*/
new DiscountFee_User_Feedback( array(
