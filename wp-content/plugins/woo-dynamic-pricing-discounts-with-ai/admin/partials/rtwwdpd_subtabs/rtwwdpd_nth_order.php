									...
									<table class='rtw_specific_tbl'>
										...
										<tr>
											...
											<td>
												...
												<input type="number" class="rtwwdpd_nth_valu" name="rtwwdpd_nth_value" value="<?php echo isset($rtwwdpd_prev_prod['rtwwdpd_nth_value']) ? esc_attr($rtwwdpd_prev_prod['rtwwdpd_nth_value']) : ''; ?>" min="1" placeholder="value of n">
