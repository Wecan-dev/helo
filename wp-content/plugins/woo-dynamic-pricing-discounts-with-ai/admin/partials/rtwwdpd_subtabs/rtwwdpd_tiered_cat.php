	...
	<div class="rtwwdpd_add_tier_cat_rule_tab rtwwdpd_active rtwwdpd_form_layout_wrapper">
		<form method="post" action="<?php echo esc_url($rtwwdpd_new_url); ?>" enctype="multipart/form-data">
					...
					<div class="panel-wrap product_data">
						...
						<div class="panel woocommerce_options_panel">
							<div class="options_group rtwwdpd_active" id="rtwwdpd_rule_tab_combi">
								<input type="hidden" id="edit_t_cat" name="edit_t_cat" value="<?php echo esc_attr($_GET['tier_cat']); ?>">
                        <table class="rtwwdpd_table_edit">
                           ...
                           <tr>
                              ...
                              <td>
								...
								<div>
									<h4 id="rtw_ab"><a><?php esc_html_e('Select Category on which this rule is apply :', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?> </a>
										<select name="category_id[]" id="rtwwdpd_category_id" class="wc-enhanced-select rtwwdpd_prod_class" multiple data-placeholder="<?php esc_attr_e('Select category', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?>">
											<?php
                        ...
                        <table id="rtwtiered_tbl_cat">
                        	<thead>
                        		<tr>
                        			<th class="rtwtable_header"><?php esc_attr_e('Tiers', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></th>
                        			<th class="rtwtable_header"><a class="rtwtiered_chk_for"><?php esc_html_e('Quantity', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?> </a><?php esc_html_e('Min', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></th>
                        			<th class="rtwtable_header"><a class="rtwtiered_chk_for"><?php esc_html_e('Quantity', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?> </a><?php esc_html_e('Max', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></th>
                        			<th class="rtwtable_header"><div id="rtw_header"><?php esc_html_e('Discount Value', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></div></th>
                                 <th></th>
                        		</tr>
                        	</thead>
                        	<tbody id="product_cat_tier">
                              ...
                              <tr>
                                 ...
                                 <td id="td_quant">
                                    <input type="number" min="1" name="quant_min[]" value="<?php echo esc_attr($row); ?>"  />
                                 </td>
                                 <td id="td_quant">
                                    <input type="number" class="quant_c_max max" min="1" name="quant_max[]" value="<?php echo esc_attr($rtwwdpd_prev_prod['quant_max'][$rows]); ?>"  />
                                 </td>
                                 <td>
                                    <input type="number" min="0.1" step="0.01" name="discount_val[]" value="<?php echo esc_attr($rtwwdpd_prev_prod['discount_val'][$rows]); ?>"  />
                                 </td>
                                 <td id="td_remove">
                                    <?php 
                                    if($rows == 0)
                        	...
                        	<tfoot>
                        		<tr>
                        			<td colspan=3>
                        				<a  class="button insert" name="rtwnsertbtn" id="rtwadd_tiered_cat" ><?php esc_html_e('Add Rule', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></a>
                        			</td>
                        		</tr>
                        	</tfoot>
                        </table>
                     ...
                     <div class="options_group rtwwdpd_inactive" id="rtwwdpd_restriction_tab_combi">
                        <table class="rtwwdpd_table_edit">
                           ...
                           <tr>
                              ...
                              <td>
                                 <input type="checkbox" value="yes" name="rtwwdpd_exclude_sale" <?php checked(isset($rtwwdpd_prev_prod['rtwwdpd_exclude_sale']) ? 'yes' : 'no', 'yes'); ?>/>
                     ...
                     <div class="options_group rtwwdpd_inactive" id="rtwwdpd_time_tab_combi">
                        <table class="rtwwdpd_table_edit">
                           <tr>
                              ...
                              <td>
                                 <input type="date" name="rtwwdpd_frm_date_c" placeholder="YYYY-MM-DD" required="required" value="<?php echo esc_attr( $rtwwdpd_prev_prod['rtwwdpd_frm_date_c']); ?>" />
                           ...
                           <tr>
                              ...
                              <td>
                                 <input type="date" name="rtwwdpd_to_date_c" placeholder="YYYY-MM-DD" required="required" value="<?php echo esc_attr( $rtwwdpd_prev_prod['rtwwdpd_to_date_c']); ?>"/>
         ...
         <div class="rtwwdpd_prod_combi_save_n_cancel rtwwdpd_btn_save_n_cancel">
         	<input class="rtw-button rtwwdpd_save_rule rtwwdpd_tiercat_save" type="button" value="<?php esc_attr_e( 'Update Rule', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>" />
...
<div class="rtwwdpd_add_tier_cat_rule_tab rtwwdpd_inactive rtwwdpd_form_layout_wrapper">
	<form method="post" action="" enctype="multipart/form-data">
                     ...
                     <table id="rtwtiered_tbl_cat">
                     	...
                     	<tbody id="product_cat_tier">
                     		<tr>
                     			...
                     			<td id="td_quant">
                     				<input type="number" class="quant_c_max max" min="1" name="quant_max[]" value="1"  />
                     			</td>
                     			<td>
                     				<input type="number" min="0.1" step="0.01" name="discount_val[]" value="1"  />
                     			</td>
                     			<td id="td_remove">
                  ...
                  <div class="options_group rtwwdpd_inactive" id="rtwwdpd_time_tab_combi">
                     <table class="rtwwdpd_table_edit">
                        <tr>
                           ...
                           <td>
                              <input type="date" name="rtwwdpd_frm_date_c" placeholder="YYYY-MM-DD" required="required" value="" />
                              <i class="rtwwdpd_description"><?php esc_html_e( 'The date from which the rule would be applied.', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>
                              <b class="rtwwdpd_required" ><?php esc_html_e( 'Required', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?></b>
                              </i>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <input type="date" name="rtwwdpd_to_date_c" placeholder="YYYY-MM-DD" required="required" value=""/>
                              <i class="rtwwdpd_description"><?php esc_html_e( 'The date till which the rule would be applied.', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>
                              <b class="rtwwdpd_required" ><?php esc_html_e( 'Required', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?></b>
                              </i>
                           </td>
      ...
      <div class="rtwwdpd_prod_combi_save_n_cancel rtwwdpd_btn_save_n_cancel">
      	<input class="rtw-button rtwwdpd_save_rule rtwwdpd_tiercat_save" type="button" value="<?php esc_attr_e( 'Save Rule', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>" />
         <input id="submit_tiercat_rule" name="rtwwdpd_tiered_cat" type="submit" hidden="hidden"/>
