<?php /* /var/www/html/helo_uniforme/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Manage/default.blade.php */ ?>
<?php
/**
 * @package   solo
    ...
    <table class="akeeba-table--striped" id="itemsList">
        ...
        <tr>
            ...
            <td class="akeeba-hidden-phone">
                <?php echo \Awf\Html\Html::_('select.genericlist', $this->profilesList, 'filter_profile', ['list.attr' => ['class' => 'akeebaGridViewAutoSubmitOnChange'], 'list.select' => $this->lists->fltProfile]); ?>
            </td>
            <td></td>
            <td></td>
