...
<div class="rtwwdpd_right">
	<div class="rtwwdpd_add_buttons">
		<input class="rtw-button rtwwdpd_tier_pro_rule" type="button" name="rtwwdpd_single_prod_rule" value="<?php esc_html_e( 'Add Tiered Rule for Product', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>" />
		<input class="rtw-button rtwwdpd_tier_cat_rule" type="button" name="rtwwdpd_combi_prod_rule" value="<?php esc_html_e( 'Add Tiered Rule for Category', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>" />
	</div>
	<?php 
...
{	
	...
	<div class="rtwwdpd_add_tier_pro_rule_tab rtwwdpd_active rtwwdpd_form_layout_wrapper">
					...
					<div class="panel-wrap product_data">
						...
						<div class="panel woocommerce_options_panel">
							<div class="options_group rtwwdpd_active" id="rtwwdpd_tiered_rule_tab">
								<input type="hidden" id="edit_tiern" name="edit_tiern" value="<?php echo esc_attr($_GET['edit_tier']); ?>">
							...
							<div>
								<h4 id="rtw_a"><a><?php esc_html_e('Select Product on which rule is applied:', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?> </a>
									<select class="wc-product-search rtwwdpd_prod_class" multiple="multiple" id="rtwtiered" name="products[]" data-placeholder="<?php esc_attr_e('Search for a product;', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?>" data-action="woocommerce_json_search_products_and_variations">
										<?php
							...
							<table id="rtwtiered_table">
								<thead>
									<tr>
										...
										<th class="rtwtable_header"><a class="rtwtiered_chk_for"><?php esc_attr_e('Quantity ', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?> </a><?php esc_attr_e('Min', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></th>
										<th class="rtwtable_header"><a class="rtwtiered_chk_for"><?php esc_attr_e('Quantity ', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?> </a><?php esc_attr_e('Max', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></th>
										<th class="rtwtable_header"><div id="rtw_header"><?php esc_attr_e('Discount value', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></div></th>
										<th></th>
									</tr>
								</thead>
								<tbody id="product_list_body">
									...
									foreach ($rtwwdpd_prev_prod['quant_min'] as $nos => $valss) {
										...
										<tr>
											...
											<td id="td_quant">
												<input type="number" class="quant_max max" min="1" name="quant_max[]" value="<?php echo esc_attr($rtwwdpd_prev_prod['quant_max'][$nos]); ?>"  />
											</td>
											<td>
												<input type="number" min="0" step="0.01" name="discount_val[]" value="<?php echo esc_attr($rtwwdpd_prev_prod['discount_val'][$nos]); ?>"  />
											</td>
											<td id="td_remove">
								...
								<tfoot>
									<tr>
										<td colspan=3>
											<a  class="button insert" name="rtwnsertbtn" id="rtwadd_tiered" ><?php esc_html_e('Add Rule', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></a>
										</td>
									</tr>
								</tfoot>
							</table>
		...
		<div class="rtwwdpd_prod_single_save_n_cancel rtwwdpd_btn_save_n_cancel">
			<input class="rtw-button rtwwdpd_save_rule rtwwdpd_tierpr_save" type="button" value="<?php esc_attr_e( 'Update Rule', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>" />
...
<div class="rtwwdpd_add_tier_pro_rule_tab rtwwdpd_inactive rtwwdpd_form_layout_wrapper">
	<form method="post" action="" enctype="multipart/form-data">
					...
					<div class="panel woocommerce_options_panel">
						<div class="options_group rtwwdpd_active" id="rtwwdpd_tiered_rule_tab">
							...
							<table class="rtwwdpd_table_edit">
                           	...
                           	<div>
								<h4 id="rtw_a"><a><?php esc_attr_e('Select Product on which rule is applied : ', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></a> 
									<select class="wc-product-search rtwwdpd_prod_class" multiple="multiple" id="rtwtiered" name="products[]" data-placeholder="<?php esc_attr_e('Search for a product;', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?>" data-action="woocommerce_json_search_products_and_variations">
									</select>
								</h4>
							</div>
							<table id="rtwtiered_table">
								...
								<tbody id="product_list_body">
									<tr>
										...
										<td>
											<input type="number" min="0" step="0.01" name="discount_val[]" value="1"  />
										</td>
										<td id="td_remove">
											<?php esc_attr_e('Min One product.', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?>
										</td>
		...
		<div class="rtwwdpd_prod_single_save_n_cancel rtwwdpd_btn_save_n_cancel">
			<input class="rtw-button rtwwdpd_save_rule rtwwdpd_tierpr_save" type="button" value="<?php esc_attr_e('Save Rule', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>" />
			<input id="submit_tierpro_rule" name="rtwwdpd_tiered_rule" type="submit" hidden="hidden"/>
	...
	<table class="rtwtable table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		<thead>
			<tr>
				...
				<th><?php esc_html_e( 'Product', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?></th>
