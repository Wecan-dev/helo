		...
		<tbody>
			<?php
				foreach ($rtwwdpd_products_option as $key => $value) {
					...
					echo '<td>'.esc_html__($value['rtwwdpd_from_date'] , 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ).'</td>';
					
					echo '<td>'.esc_html__($value['rtwwdpd_to_date'] , 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ).'</td>';
