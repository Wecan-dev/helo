					...
					<div class="inside">
						<div class="panel-wrap product_data">
							...
							<div class="panel woocommerce_options_panel">
								<div class="options_group rtwwdpd_active" id="rtwbogo_rule_tab">
									...
									<table id="rtwproduct_table" class="rtwwdpd_show_purchase_prod">
										...
										<tbody id="product_list_body">
											...
											<td id="td_quant">
												<input type="number" min="0" name="combi_quant[]" value="<?php echo isset($rtwwdpd_prev_prod['combi_quant'][$key]) ? $rtwwdpd_prev_prod['combi_quant'][$key] : ''; ?>"  />
											</td>
											<td id="td_remove">
								...
								<caption class="rtw_tbltitle"><?php esc_html_e('Free Product', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></caption>
									...
									<tbody id="rtw_bogo_row">
										...
										foreach ($rtwwdpd_prev_prod['rtwbogo'] as $key => $val) {
											...
											<tr>
												...
												<td id="td_quant">
													<input type="number" min="0" name="bogo_quant_free[]" value="<?php echo isset($rtwwdpd_prev_prod['bogo_quant_free'][$key]) ? esc_attr($rtwwdpd_prev_prod['bogo_quant_free'][$key]) : ''; ?>"  />
												</td>
												<td id="td_remove">
													<a class="button insert remove" name="deletebtn" id="deletebtn" ><?php esc_html_e('Remove', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai'); ?></a>
												</td>
