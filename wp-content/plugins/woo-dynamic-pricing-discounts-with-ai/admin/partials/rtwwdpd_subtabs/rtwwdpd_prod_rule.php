								...
								<div class="options_group rtwwdpd_active" id="rtwwdpd_rule_tab">
									...
									<table class="rtwwdpd_table_edit">
										...
										<tr id="product_id">
						            		...
						            		<td>
						            			<select class="wc-product-search rtwwdpd_prod_class" name="product_id" data-action="woocommerce_json_search_products_and_variations" placeholder="<?php esc_html_e('Search for a product','rtwwdpd-woo-dynamic-pricing-discounts-with-ai') ?>" >
						            				<?php 
...
<div class="rtwwdpd_right">
	...
	<div class="rtwwdpd_add_main_wrapper rtwwdpd_form_layout_wrapper">
		<div class="rtwwdpd_add_single_rule">
			<form id="product_rule" action="" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
				<div id="woocommerce-product-data" class="postbox ">
					<div class="inside">
						<div class="panel-wrap product_data">
							<ul class="product_data_tabs wc-tabs">
