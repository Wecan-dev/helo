...
"100%");f.setAttribute("height",400);f.setAttribute("frameborder",0);f.setAttribute("allowtransparency","true");d.appendChild(f);akeeba.Configuration.fsBrowser.modalObject=akeeba.Modal.open({inherit:"#"+akeeba.Configuration.fsBrowser.params.dialogId,width:"80%"})};
...
initdir:document.getElementById(b+"_initial_directory").value,usessl:document.getElementById(b+"_ftps").checked,passive:document.getElementById(b+"_passive_mode").checked,passive_mode_workaround:0}}if(d)try{a.passive_mode_workaround=document.getElementById("var["+b+".passive_mode_workaround]").checked}catch(c){a.passive_mode_workaround=document.getElementById(b+"_passive_mode_workaround").checked}a.ajaxURL=akeeba.Configuration.URLs.testFtp;akeeba.System.doAjax(a,function(c){document.getElementById(akeeba.Configuration.FtpTest.buttonKey).removeAttribute("disabled");
var e=document.getElementById("testFtpDialogBodyOk"),g=document.getElementById("testFtpDialogBodyFail"),h=document.getElementById("testFtpDialogLabel");e.style.display="none";g.style.display="none";!0===c?(h.textContent=akeeba.System.Text._("COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK"),e.textContent=akeeba.System.Text._("COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK"),e.style.display="block",g.style.display="none"):(h.textContent=akeeba.System.Text._("COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL"),g.textContent=c,e.style.display=
"none",g.style.display="block");akeeba.Modal.open({inherit:"#testFtpDialog",width:"80%"})},null,!1,15E3)};
...
akeeba.Configuration.parseGuiData=function(a,b){null==b&&(b=document.getElementById("akeebagui"));b.innerHTML="";var d=0,f;for(f in a)if(a.hasOwnProperty(f)){var c=a[f];d++;if(!empty(c)){var e=document.createElement("div");e.className="akeeba-panel--info";b.appendChild(e);var g=document.createElement("header");g.id="auigrp_"+b.id+"_"+d;g.className="akeeba-block-header";var h=document.createElement("h5");h.innerHTML=f;g.appendChild(h);e.appendChild(g);for(var l in c)if(c.hasOwnProperty(l)){g=c[l];
h="var["+l+"]";var k=document.createElement("div");k.className="akeeba-ui-optionrow akeeba-form-group";k.id="akconfigrow."+l;"hidden"!==g.type&&"none"!==g.type&&e.appendChild(k);akeeba.Configuration.GUI.renderOptionLabel(h,g,k);var q=document.createElement("div");q.className="akeeba-form-controls";var n="renderOptionType"+(g.type[0].toUpperCase()+g.type.slice(1));if("function"===typeof akeeba.Configuration.GUI[n])akeeba.Configuration.GUI[n](h,g,q,k,e);else akeeba.Configuration.GUI.renderOptionTypeUnknown(h,
g,q,k,e)}}}akeeba.Configuration.enablePopoverFor(b.querySelectorAll('[rel="akeeba-sticky-tooltip"]'))};
...
akeeba.Configuration.GUI.renderOptionTypeEngine=function(a,b,d,f,c){var e=b.subtype;if(null!=akeeba.Configuration.engines[e]){var g=a.substr(4,a.length-5),h=document.createElement("div");h.id=g+"_config";h.className="akeeba-hidden-mobile akeeba-hidden-desktop akeeba-engine-options";var l=document.createElement("select");l.id=a;l.setAttribute("name",a);a=akeeba.Configuration.engines[e];for(var k in a)if(a.hasOwnProperty(k)){c=a[k];var q=document.createElement("option");q.value=k;q.innerHTML=c.information.title;
b["default"]==k&&q.setAttribute("selected","selected");l.appendChild(q)}akeeba.System.addEventListener(l,"change",function(n){n={};var m=[document.getElementById(g+"_config").querySelectorAll("input"),document.getElementById(g+"_config").querySelectorAll("select")];for(i=0;i<m.length;i++){var t=m[i];if(t.length)for(j=0;j<t.length;j++){var p=t[j];var r=p.id;n[r]=p.value;"checkbox"==p.getAttribute("type")?n[r]=p.checked:"select"==p.getAttribute("type")&&(n[r]=p.options[p.selectedIndex].value)}}var u=
akeeba.Configuration.engines[e][l.value];m={};m[u.information.title]=u.parameters;akeeba.Configuration.parseGuiData(m,h);m=h.querySelector("header");m instanceof Element&&m.insertAdjacentHTML("afterend",'<p class="akeeba-block--information">'+u.information.description+"</p>");m=[document.getElementById(g+"_config").querySelectorAll("input"),document.getElementById(g+"_config").querySelectorAll("select")];for(i=0;i<m.length;i++)if(t=m[i],t.length)for(j=0;j<t.length;j++)p=t[j],r=p.id,r=n[r],null!=r&&
void 0!=r&&("checkbox"==p.getAttribute("type")?r?p.setAttribute("checked","checked"):p.removeAttribute("checked"):p.value=r,1==i&&akeeba.System.triggerEvent(p,"change"));if("undefined"!==typeof u.information.activation_callback)window[u.information.activation_callback](u.parameters)});k=document.createElement("button");k.className="akeeba-btn--small--dark";a=document.createElement("span");a.className="akion-wrench";k.appendChild(a);a=document.createElement("span");a.innerHTML=akeeba.System.Text._("COM_AKEEBA_CONFIG_UI_CONFIG");
k.appendChild(a);akeeba.System.addEventListener(k,"click",function(n){akeeba.System.toggleClass(h,"akeeba-hidden-mobile");akeeba.System.toggleClass(h,"akeeba-hidden-desktop");n.preventDefault?n.preventDefault():n.returnValue=!1});a=document.createElement("span");a.innerHTML="&nbsp;";d.appendChild(l);d.appendChild(a);d.appendChild(k);d.appendChild(h);f.appendChild(d);if(null!=akeeba.Configuration.engines[e][b["default"]]&&(d=akeeba.Configuration.engines[e][b["default"]],f=d.information.title,k={},
k[f]=d.parameters,0!=b["protected"]&&(document.createElement("span").textContent=f,l.style.display="none"),akeeba.Configuration.parseGuiData(k,h),b=h.querySelector("header"),b instanceof Element&&b.insertAdjacentHTML("afterend",'<p class="akeeba-block--information">'+d.information.description+"</p>"),"undefined"!==typeof d.information.activation_callback))window[d.information.activation_callback](d.parameters)}};
...
akeeba.Configuration.GUI.renderOptionTypeEnum=function(a,b,d,f,c){var e=document.createElement("select");e.className="akeeba-configuration-select-enum";e.id=a;e.setAttribute("name",a);a=b.enumvalues.split("|");c=b.enumkeys.split("|");for(counter=0;counter<a.length;counter++){var g=a[counter],h=c[counter],l=document.createElement("option");l.value=g;l.innerHTML=h;g==b["default"]&&l.setAttribute("selected","selected");e.appendChild(l)}"undefined"!==typeof b.onchange&&akeeba.System.addEventListener(e,
...
(m=b.max);e.value=m;g.value=(m/b.scale).toFixed(2)});var h=document.createElement("select");h.id=c+"_dropdown";h.setAttribute("name",c+"_dropdown");h.className="akeeba-form-input-small";c=b.shortcuts.split("|");var l=b.scale;a=!1;for(counter=0;counter<c.length;counter++){var k=c[counter],q=k/l,n=document.createElement("option");n.value=k;n.innerHTML=q.toFixed(2);k==b["default"]&&(n.setAttribute("selected","selected"),a=!0);h.appendChild(n)}c=document.createElement("option");c.value=-1;c.innerHTML=
...
l=document.createElement("span"),l.textContent=" "+a,c.appendChild(h),c.appendChild(g),c.appendChild(l),d.appendChild(c));d.appendChild(e);f.appendChild(d)};
...
akeeba.Configuration.GUI.renderOptionTypeButton=function(a,b,d,f,c){c=f.querySelector("label");var e=b.hook;b=c.innerHTML;var g=document.createElement("button");g.id=a;g.innerHTML=b;g.className="akeeba-btn--grey";c.innerHTML="&nbsp;";akeeba.System.addEventListener(g,"click",function(h){h.preventDefault?h.preventDefault():h.returnValue=!1;try{window[e]()}catch(l){}});d.appendChild(g);f.appendChild(d)};
...
akeeba.Configuration.onChangeDbDriver=function(){var a=this.value,b=document.getElementById("akconfigrow.akeeba.platform.dbhost"),d=document.getElementById("akconfigrow.akeeba.platform.dbport"),f=document.getElementById("akconfigrow.akeeba.platform.dbusername"),c=document.getElementById("akconfigrow.akeeba.platform.dbpassword"),e=document.getElementById("akconfigrow.akeeba.platform.dbprefix"),g=document.getElementById("akconfigrow.akeeba.platform.dbname");b.style.display="grid";d.style.display="grid";
f.style.display="grid";c.style.display="grid";e.style.display="grid";g.style.display="grid";if("sqlite"==a||"none"==a)b.style.display="none",d.style.display="none",f.style.display="none",c.style.display="none",e.style.display="none",b.value="",d.value="",f.value="",c.value="",e.value="";"none"==a&&(g.value="",g.style.display="none")};akeeba_directftp_init_browser=function(){akeeba.Configuration.FtpBrowser.initialise("engine.archiver.directftp.initial_directory","engine.archiver.directftp")};
...
akeeba.System.doAjax(b,function(d){if(0===d.length)alert("ERROR: Could not retrieve list of Google Drives.");else{var f=document.getElementById("var[engine.postproc.googledrive.team_drive]");f.innerHTML="";for(var c=0;c<d.length;c++){var e=document.createElement("option");e.value=d[c][0];e.text=d[c][1];a["engine.postproc.googledrive.team_drive"]["default"]===e.value&&(e.selected=!0);f.appendChild(e)}}},function(d){alert("ERROR: Could not retrieve list of Google Drives. Error: \n"+d)},!1,15E3)};
akconfig_box_openoauth=function(){var a=akeeba.Configuration.URLs.dpeauthopen;a=-1==a.indexOf("?")?a+"?":a+"&";window.open(a+"engine=box","akeeba_box_window","width=1010,height=500,opener")};akconfig_box_oauth_callback=function(a){document.getElementById("var[engine.postproc.box.access_token]").value=a.access_token;document.getElementById("var[engine.postproc.box.refresh_token]").value=a.refresh_token;myWindow=window.open("","akeeba_box_window");myWindow.close()};
akconfig_pcloud_openoauth=function(){var a=akeeba.Configuration.URLs.dpeauthopen;a=-1==a.indexOf("?")?a+"?":a+"&";window.open(a+"engine=pcloud","akeeba_pcloud_window","width=1010,height=500,opener")};akconfig_pcloud_oauth_callback=function(a){document.getElementById("var[engine.postproc.pcloud.access_token]").value=a.access_token;myWindow=window.open("","akeeba_pcloud_window");myWindow.close()};
akeeba.System.documentReady(function(){akeeba.Configuration.URLs=akeeba.System.getOptions("akeeba.Configuration.URLs",{});"undefined"!==typeof akeeba.Configuration.URLs.dpecustomapi&&(akeeba.System.params.AjaxURL=akeeba.Configuration.URLs.dpecustomapi);var a=akeeba.System.getOptions("akeeba.Configuration.GUIData",null);null!==a&&akeeba.Configuration.parseConfigData(a,function(){akeeba.Configuration.enablePopoverFor(document.querySelectorAll('[rel="popover"]'));var b=document.getElementById("var[akeeba.platform.dbdriver]");
akeeba.System.addEventListener(b,"change",akeeba.Configuration.onChangeDbDriver);akeeba.System.triggerEvent(b,"change");setTimeout(akeeba.Configuration.restoreDefaultPasswords,1E3)})}); //# sourceMappingURL=configuration.min.map
